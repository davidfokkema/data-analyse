...
\begin{frame}{Representatie van veel metingen}
  ...
  \begin{center}
    \begin{tikzpicture}
      \draw[thick] (-5, 0) -- (5, 0);
      \foreach \x in {-4, -3, ..., 4} {
        \draw[thick] (\x, -15pt) -- (\x, -20pt) node[below] {\x};
      }
      \path (0, 35pt) -- (0, -20pt);
...
\begin{frame}{Error function}
  \begin{center}
    \input{scripts/slide-errorfunction-edited}
  \end{center}
\end{frame}
...
\begin{frame}{Samenvatting}
  ...
  \item
    ...
    \item
      Wiskundige verantwoording van het gemiddelde en de standaarddeviatie als beste schatters voor de werkelijke waarde en de onzekerheid
    \end{itemize}}
  \end{itemize}
\end{frame}

...
\begin{frame}{Lineaire Regressie}
  ...
  \begin{gather*}
    \uncover<3->{\frac{\partial g}{\partial A} = 2\sum(y_i - A _ Bx_i) = 0} \uncover<4->{\leadsto \alert{\textstyle\sum y_i - AN - B\textstyle\sum x_i = 0}} \\
...
\begin{frame}{$\chi^2$-verdeling}
  \begin{center}
    \input{scripts/slide-chisq-histogram}
  \end{center}

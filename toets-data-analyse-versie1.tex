...
\suppressfloats[t]
\begin{questions}
  \uplevel{Anouk wil de valversnelling $g$ bepalen met de slingerproef. Zij bevestigt daartoe een massieve bol aan een dun koord en meet voor verschillende lengtes $L$ van het koord 20 slingeringen. De onzekerheid in de tijdmeting is \SI{0,2}{\second}. Op basis van haar ruwe metingen berekent zij de waargenomen slingertijd (met een onzekerheid van \SI{0,01}{\second}). Het resultaat van de bewerkte metingen is weergegeven in \tabref{tab:metingen}. De lengtes zijn gemeten met een te verwaarlozen onzekerheid.}
  ...
  \begin{table}
    ...
    \begin{tabular}{
      ...
      $T$ & [\si{\second}] & 0,75 & 0,97 & 1,16 & 1,38 & 1,47 & 1,59 & 1,72 & 1,85 & 1,93 & 2,04 \\
    \end{tabular}
  \end{table}
  ...
  \question Aangenomen dat \eqref{eq:slingertijd-offset} inderdaad geldig is, bereken dan de kans op een meting bij \SI{40}{\centi\meter} die minstens zo hoog is als de waarde die Anouk heeft gevonden. Maak gebruik van Appendix B in Taylor.
